<?php get_header(); ?> 
                  ...
                  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
                    <h1><?php printf(_c('%s|Daily archive page'), get_the_time(__('F jS, Y'))); ?></h1>
                  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
                    <h1><?php printf(_c(' %s|Monthly archive page'), get_the_time(__('F, Y'))); ?></h1>
                  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
                    <h1><?php printf(_c(' %s|Yearly archive page'), get_the_time(__('Y'))); ?></h1>
			...
			if ( has_post_thumbnail() ) { ?>
                    ...
                    <div class="article-over">
                      ...
                      <div class="postmetadata">
                         ...
                         <br><br><?php the_tags(__('<span></span>') . ' ', ', ', '<br />'); ?>
                      </div>
                    </div>
                </li> <?php ?>
            <?php endwhile; ?>
