...
function validate_form()
{
	...
	var iserror =false;
		var errorMsg = "";
			...
			var Elem = document.getElementById("Input_userName");
			if(Elem)
			{
				if(Elem.value =="")
				{
...
{
	var arr_hidelist = new Array("Input_userId","Input_personId");
	var arr_showlist = new Array("Input_userName","Input_password","Input_userType");
...
function UI_createTopbarSubUserHtmlElem(obj_User)
{
	...
	var html = "";
	var ElemLi = document.createElement("li");
		ElemLi.setAttribute("class", "topbar_subUser");
		html ="<a href=\"?page=dashboard&userId="+obj_User.userId+"\">"+obj_User.userId+"</a>";
	...
	var ElemId = "UserListRow_"+obj_User.userId;
		...
		case "update": {
			...
			if(DummyRow) {
				...
				UI_createTopbarSubUserHtmlElem(obj_User);
				UI_hidecontentError(checkNodeCount =true);
			}
