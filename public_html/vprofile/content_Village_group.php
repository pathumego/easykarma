...
function loadVillage_group($_GET)
{
global $LANG;
...
<ul>
	...
	//	{	
		echo "<li class=\"btnleft\"><a href=\"?page=Dashboard\" id=\"btnback\"><div class=\"doublearrow\">&laquo;</div>&nbsp;BACK</a></li>";
  		echo "<li class=\"btnright\"><a id=\"btnaddVillage_group\" href=\"#\"><div class=\"doublearrow\">+</div>ADD Village_group</a></li>";
	//	}
	?>
</ul>
</div>
...
<div class="title_user">Manage Village_group</div>
...
<ul id="Village_groupList" class="main_listviewul">
<?php
...
if(count($arr_Village_groupList)>0)
{
 ...
 foreach($arr_Village_groupList as $obj_Village_group)
 {
 		...
 		$html = "<li class=\"ListRow\" id=\"Village_groupListRow_".$obj_Village_group->VillageId."\">";
		$html .= "<div class=\"datarow\">".$obj_Village_group->GroupId."</div>";
		$html .= "<div class=\"datarow\">".$obj_Village_group->VillageId."</div>";
	  
		$html .= "<div class=\"databtncell\"><a href=\"#\" class=\"rowbtn\">Edit</a></div>";
	  	$html .= "<div class=\"databtncell\"><a href=\"#\" class=\"rowbtn\">Delete</a></div>";
		$html .= "<input id=\"Village_group_".$obj_Village_group->VillageId."\" type = \"hidden\" value=\"".$obj_Village_group->getVillage_groupData()."\"></li>";
			
		echo $html;
 }
}
echo "<div id=\"contentError\" class=\"contenterror_hidden\">No Village_group found... </div>";	
}
else{
echo "<div id=\"contentError\" class=\"contenterror\">No Village_group found... </div>";	
}
...
<div id="popVillage_groupform" class="formPopup">
<div class="subheader"><?PHP echo $LANG['SUBHEADER_VILLAGE_GROUP'];?></div>
<div class="formerror" id="formerror"></div>
<input type="hidden" id="FormMode" name="FormMode" value="add" >
<ul class="Village_groupform">
<li><div class="label"><?php echo $LANG['GROUPID'];?></div><div class="fromfield">
<input type="hidden"  id="Input_GroupId" name="Input_GroupId" value="" class="form_area_textbox">
<input type="text"  id="Dummy_Input_GroupId" name="Dummy_Input_GroupId" value="" class="form_area_textbox">
</div></li>
