...
<div class="subheader"><?PHP echo $LANG['SUBHEADER_USER'];?></div>
<div class="formerror" id="formerror"></div>
<input type="hidden" id="FormMode" name="FormMode" value="add" >
<ul class="Userform">
<li><div class="label"><?php echo $LANG['USERID'];?></div><div class="fromfield"><input type="text"  id="Input_userId" name="Input_userId" value="" class="form_area_textbox"></div></li>
<li><div class="label"><?php echo $LANG['USERNAME'];?></div><div class="fromfield"><input type="text"  id="Input_userName" name="Input_userName" value="" class="form_area_textbox"></div></li>
<li><div class="label"><?php echo $LANG['PASSWORD'];?></div><div class="fromfield"><input type="text"  id="Input_password" name="Input_password" value="" class="form_area_textbox"></div></li>
...
<li><div class="label"><?php echo $LANG['USERTYPE'];?></div><div class="fromfield"><input type="text"  id="Input_userType" name="Input_userType" value="" class="form_area_textbox"></div></li>
